...
define('UI_TRANSLATIONS', [
    ...
    'policy_effective_date' => [
        'af' => 'Ingangsdatum',
        'en' => 'Effective date',
        'zu' => 'Usuku lokusebenza',
        'xh' => 'Umhla wokusebenza',
        'pt' => 'Data de vigência'
    ],
    'policy_info_collect' => [
        'af' => 'Inligting wat ons versamel',
        'en' => 'Information we collect',
        'zu' => 'Ulwazi esiluthathayo',
        'xh' => 'Ulwazi esiluthathayo',
        'pt' => 'Informações que coletamos'
    ],
    'policy_info_collect_desc' => [
        'af' => 'Wanneer jy registreer en die app gebruik, kan ons die volgende versamel:',
        'en' => 'When you register and use the app we may collect the following:',
        'zu' => 'Uma ubhalisa futhi usebenzisa uhlelo lokusebenza singathatha okulandelayo:',
        'xh' => 'Xa ubhalisa kwaye usebenzisa usetyenziswo sinokuqokelela oku kulandelayo:',
        'pt' => 'Ao se registrar e usar o aplicativo, podemos coletar o seguinte:'
    ],
    'policy_info_name_email' => [
        'af' => 'Naam en e-posadres',
        'en' => 'Name and email address',
        'zu' => 'Igama nekheli le-imeyili',
        'xh' => 'Igama nedilesi ye-imeyile',
        'pt' => 'Nome e endereço de e-mail'
    ],
    'policy_info_congregation' => [
        'af' => 'Gemeente- en ampsinligting',
        'en' => 'Congregation and office information',
        'zu' => 'Ulwazi lwebandla nehhovisi',
        'xh' => 'Ulwazi lwebandla kunye neofisi',
        'pt' => 'Informações da congregação e cargo'
    ],
    'policy_info_usage' => [
        'af' => 'Gebruiksdata en voorkeure',
        'en' => 'Usage data and preferences',
        'zu' => 'Idatha yokusetshenziswa nezintandokazi',
        'xh' => 'Idatha yokusetyenziswa kunye nezikhethwa',
        'pt' => 'Dados de uso e preferências'
    ],
    'policy_how_use' => [
        'af' => 'Hoe ons jou inligting gebruik',
        'en' => 'How we use your information',
        'zu' => 'Indlela esisebenzisa ngayo ulwazi lwakho',
        'xh' => 'Indlela esisebenzisa ngayo ulwazi lwakho',
        'pt' => 'Como usamos suas informações'
    ],
    'policy_how_use_desc' => [
        'af' => 'Ons gebruik jou inligting om:',
        'en' => 'We use your information to:',
        'zu' => 'Sisebenzisa ulwazi lwakho ukuze:',
        'xh' => 'Sisebenzisa ulwazi lwakho ukuze:',
        'pt' => 'Usamos suas informações para:'
    ],
    'policy_use_account' => [
        'af' => 'Jou rekening te bestuur en toegang te verleen',
        'en' => 'Manage your account and provide access',
        'zu' => 'Ukuphatha i-akhawunti yakho nokunikeza ukufinyelela',
        'xh' => 'Ukulawula iakhawunti yakho kunye nokunikezela ufikelelo',
        'pt' => 'Gerenciar sua conta e fornecer acesso'
    ],
    'policy_use_experience' => [
        'af' => 'Jou ervaring te personaliseer',
        'en' => 'Personalise your experience',
        'zu' => 'Ukwenza isipiliyoni sakho sibe ngesizifanele',
        'xh' => 'Ukwenza amava akho abe ngawakho',
        'pt' => 'Personalizar sua experiência'
    ],
    'policy_use_notify' => [
        'af' => 'Kennisgewings en opdaterings te stuur',
        'en' => 'Send notifications and updates',
        'zu' => 'Ukuthumela izaziso nezibuyekezo',
        'xh' => 'Ukuthumela izaziso kunye nohlaziyo',
        'pt' => 'Enviar notificações e atualizações'
    ],
    'policy_data_storage' => [
        'af' => 'Databerging en sekuriteit',
        'en' => 'Data storage and security',
        'zu' => 'Ukugcinwa kwedatha nokuvikeleka',
        'xh' => 'Ukugcinwa kwedatha nokhuseleko',
        'pt' => 'Armazenamento e segurança de dados'
    ],
    'policy_data_storage_desc' => [
        'af' => 'Jou data word veilig op beskermde bedieners gestoor. Ons gebruik versleuteling en veilige sessies om jou inligting te beskerm.',
        'en' => 'Your data is stored securely on protected servers. We use encryption and secure sessions to protect your information.',
        'zu' => 'Idatha yakho igcinwa ngokuphephile kumaseva avikelwe. Sisebenzisa ukubethela namaseshini aphephile ukuvikela ulwazi lwakho.',
        'xh' => 'Idatha yakho igcinwa ngokukhuselekileyo kwiseva ezikhuselweyo. Sisebenzisa i-encryption kunye neeseshini ezikhuselekileyo ukukhusela ulwazi lwakho.',
        'pt' => 'Seus dados são armazenados com segurança em servidores protegidos. Usamos criptografia e sessões seguras para proteger suas informações.'
    ],
    'policy_sharing' => [
        'af' => 'Deel van inligting',
        'en' => 'Information sharing',
        'zu' => 'Ukwabelana ngolwazi',
        'xh' => 'Ukwabelana ngolwazi',
        'pt' => 'Compartilhamento de informações'
    ],
    'policy_sharing_desc' => [
        'af' => 'Ons verkoop of deel nie jou persoonlike inligting met derde partye nie, behalwe soos vereis deur die wet.',
        'en' => 'We do not sell or share your personal information with third parties, except as required by law.',
        'zu' => 'Asithengisi noma sabelane ngolwazi lwakho lomuntu siqu nabantu besithathu, ngaphandle kokuthi kudingwa umthetho.',
        'xh' => 'Asithengisi okanye sabelane ngolwazi lwakho lobuqu nabantu besithathu, ngaphandle kokuba kufunwa ngumthetho.',
        'pt' => 'Não vendemos nem compartilhamos suas informações pessoais com terceiros, exceto conforme exigido por lei.'
    ],
    'policy_cookies' => [
        'af' => 'Koekies en sessies',
        'en' => 'Cookies and sessions',
        'zu' => 'Amakhukhi namaseshini',
        'xh' => 'Iikhukhi kunye neeseshini',
        'pt' => 'Cookies e sessões'
    ],
    'policy_cookies_desc' => [
        'af' => 'Ons gebruik sessiekoekies om jou aangeteken te hou. Hierdie koekies is noodsaaklik vir die werking van die app.',
        'en' => 'We use session cookies to keep you logged in. These cookies are essential for the app to function.',
        'zu' => 'Sisebenzisa amakhukhi eseshini ukukugcina ungene. Lawa makhukhi abalulekile ukuze uhlelo lokusebenza lusebenze.',
        'xh' => 'Sisebenzisa iikhukhi zeseshini ukukugcina ungene. Ezi khukhi zibalulekile ukuze usetyenziswo lusebenze.',
        'pt' => 'Usamos cookies de sessão para mantê-lo conectado. Esses cookies são essenciais para o funcionamento do aplicativo.'
    ],
    'policy_rights' => [
        'af' => 'Jou regte',
        'en' => 'Your rights',
    ...
    'policy_rights_desc' => [
        'af' => 'Jy het die reg om:',
        'en' => 'You have the right to:',
        'zu' => 'Unelungelo lokuthi:',
        'xh' => 'Unelungelo lokuba:',
        'pt' => 'Você tem o direito de:'
    ],
    'policy_rights_access' => [
        'af' => 'Toegang tot jou persoonlike data te versoek',
        'en' => 'Request access to your personal data',
        'zu' => 'Ucele ukufinyelela idatha yakho yomuntu siqu',
        'xh' => 'Ucele ukufikelela idatha yakho yobuqu',
        'pt' => 'Solicitar acesso aos seus dados pessoais'
    ],
    'policy_rights_correct' => [
        'af' => 'Regstelling van onakkurate data te versoek',
        'en' => 'Request correction of inaccurate data',
        'zu' => 'Ucele ukulungiswa kwedatha engalungile',
        'xh' => 'Ucele ukulungiswa kwedatha engachanekanga',
        'pt' => 'Solicitar correção de dados imprecisos'
    ],
    'policy_rights_delete' => [
        'af' => 'Verwydering van jou data te versoek',
        'en' => 'Request deletion of your data',
        'zu' => 'Ucele ukusulwa kwedatha yakho',
        'xh' => 'Ucele ukucinywa kwedatha yakho',
        'pt' => 'Solicitar exclusão dos seus dados'
    ],
    'policy_contact' => [
        'af' => 'Kontak ons',
        'en' => 'Contact us',
    ...
    'policy_contact_desc' => [
        'af' => 'Vir enige vrae oor hierdie privaatheidsbeleid, kontak asseblief die kerkadministrasie.',
        'en' => 'For any questions about this privacy policy, please contact the church administration.',
        'zu' => 'Uma unemibuzo mayelana nale nqubomgomo yobumfihlo, sicela uxhumane nokuhlanganiswa kwebandla.',
        'xh' => 'Ukuba unemibuzo malunga nalo mgaqo-nkqubo wabucala, nceda uqhagamshelane nolawulo lwecawa.',
        'pt' => 'Para quaisquer perguntas sobre esta política de privacidade, entre em contato com a administração da igreja.'
    ],
    'navigation' => [
        'af' => 'Navigasie',
        'en' => 'Navigation',
