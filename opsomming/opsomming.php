...
// ---------------------------------------------------------------------
$availableBooks = ['genesis', 'exodus', 'levitikus', 'numeri', 'deuteronomium', 'josua', 'rigters', 'rut', '1samuel', 'mattheus', 'markus', 'lukas', 'johannes', 'handelinge', 'romeine', '1korinthiers', '2korinthiers', 'galasiers', 'efesiers', 'filippense', 'kolossense', '1thessalonicense', '2thessalonicense', '1timotheus', '2timotheus', 'titus', 'filemon', 'hebreers', 'jakobus', '1petrus', '2petrus', '1johannes', '2johannes', '3johannes', 'judas', 'openbaring'];
$bookConfig = [];
