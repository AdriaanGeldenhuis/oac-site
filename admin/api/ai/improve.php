...
// ✅ NO headers yet - load dependencies first
error_log('=====================================');
error_log('🔍 IMPROVE.PHP START');
error_log('=====================================');

// ✅ Load dependencies WITHOUT any output
...
// ✅ NOW we can safely set headers (after session_start)
ob_start();
